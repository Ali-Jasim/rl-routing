...
class QNetwork(nn.Module):
    def __init__(self, input_shape, actions, hidden_layer):
        super().__init__()
        self.l1 = nn.Linear(*input_shape, hidden_layer*2)
...
class Agent():
    def __init__(self, actions, input_shape, eps, hidden_layer,
                 lr=0.005, gamma=0.9,
                 batch_size=128, buffer_size=250, replace_thresh=100,
                 eps_min=0.01, eps_dec=0.99):
        ...
        self.optim = optim.Adam(self.Q.parameters(), lr)
